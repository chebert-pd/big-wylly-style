...
const PROGRESS_ROWS: PropRow[] = [
  {
    ...
    default: '"default"',
    description:
      "Color scheme for the progress bar. Brand uses the brand token set.",
  },
  {
    prop: "value",
    type: "number | null",
  ...
  return (
    <div className="space-y-16">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <Card level={1}>
          <CardHeader>
            <CardTitle className="label-md">Brand (50%)</CardTitle>
            <CardDescription>
              Uses the brand color scheme for branded contexts.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <Progress variant="brand" value={50} />
          </CardContent>
        </Card>
        ...
        <Card level={1}>
          <CardHeader>
            <CardTitle className="label-md">Brand (100%)</CardTitle>
            <CardDescription>
              Brand variant at full completion.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <Progress variant="brand" value={100} />
          </CardContent>
        </Card>
      </div>
