...
const grayScale = [
  ...
  { name: "gray-29", oklch: "oklch(0.2875 0.012 288)"  },
  { name: "gray-26", oklch: "oklch(0.2625 0.011 288)"  },
  { name: "gray-22", oklch: "oklch(0.2165 0.009 288)"  },
...
const semanticColors: {
...
}[] = [
  {
    ...
    tokens: [
      ...
      { token: "card", description: "Primary surface (level 1)", lightValue: "oklch(1 0 0)", darkValue: "--gray-22" },
  ...
  },
  {
    section: "Interactive",
    tokens: [
      { token: "primary", description: "Primary action / emphasis", lightValue: "--gray-19", darkValue: "--gray-83" },
      { token: "primary-foreground", description: "Text on primary", lightValue: "--gray-98", darkValue: "--gray-19" },
      { token: "accent", description: "Accent / hover surface", lightValue: "--gray-94", darkValue: "--gray-40" },
      { token: "accent-foreground", description: "Text on accent", lightValue: "--gray-19", darkValue: "--gray-98" },
      { token: "link", description: "Link color", lightValue: "--gray-33", darkValue: "--gray-73" },
      { token: "link-hover", description: "Link hover color", lightValue: "--gray-19", darkValue: "--gray-83" },
    ],
  },
  {
    section: "Borders",
    tokens: [
      { token: "border", description: "Primary structural border", lightValue: "--gray-91", darkValue: "--gray-29" },
      { token: "border-subtle", description: "Subtle / nested border", lightValue: "--gray-94", darkValue: "--gray-26" },
  ...
  },
  {
    section: "Feedback",
    tokens: [
      { token: "success", description: "Success background", lightValue: "emerald-50", darkValue: "emerald-950" },
      { token: "success-border", description: "Success border", lightValue: "emerald-200", darkValue: "emerald-900" },
      { token: "success-foreground", description: "Success text", lightValue: "emerald-600", darkValue: "emerald-400" },
      { token: "warning", description: "Warning background", lightValue: "amber-50", darkValue: "amber-950" },
      { token: "warning-border", description: "Warning border", lightValue: "amber-200", darkValue: "amber-900" },
      { token: "warning-foreground", description: "Warning text", lightValue: "amber-600", darkValue: "amber-400" },
      { token: "destructive", description: "Destructive background", lightValue: "rose-50", darkValue: "rose-950" },
      { token: "destructive-border", description: "Destructive border", lightValue: "rose-200", darkValue: "rose-900" },
      { token: "destructive-foreground", description: "Destructive text", lightValue: "rose-600", darkValue: "rose-400" },
      { token: "destructive-solid", description: "Destructive solid bg", lightValue: "rose-600", darkValue: "rose-400" },
      { token: "destructive-solid-foreground", description: "Destructive solid text", lightValue: "rose-50", darkValue: "rose-950" },
    ],
  },
  {
    section: "Domain",
    tokens: [
      { token: "brand", description: "Brand background", lightValue: "--violet-97", darkValue: "--violet-20" },
      { token: "brand-border", description: "Brand border", lightValue: "--violet-89", darkValue: "--violet-39" },
      { token: "brand-foreground", description: "Brand text", lightValue: "--violet-58", darkValue: "--violet-80" },
      { token: "brand-solid", description: "Brand solid bg", lightValue: "--violet-58", darkValue: "--violet-72" },
      { token: "brand-solid-foreground", description: "Brand solid text", lightValue: "--violet-99", darkValue: "--violet-99" },
      { token: "review", description: "Review background", lightValue: "--orange-96", darkValue: "oklch(0.20 0.08 50)" },
      { token: "review-border", description: "Review border", lightValue: "--orange-84", darkValue: "oklch(0.36 0.14 50)" },
      { token: "review-foreground", description: "Review text", lightValue: "--orange-61", darkValue: "oklch(0.84 0.18 50)" },
    ],
  },
  {
    section: "Charts",
    tokens: [
      ...
      { token: "chart-3", description: "Chart color 3", lightValue: "--violet-58", darkValue: "--violet-58" },
      { token: "chart-4", description: "Chart color 4", lightValue: "--violet-45", darkValue: "--violet-45" },
      { token: "chart-5", description: "Chart color 5", lightValue: "--violet-39", darkValue: "--violet-39" },
    ],
  },
  {
    section: "Sidebar",
    tokens: [
      { token: "sidebar", description: "Sidebar background", lightValue: "--background", darkValue: "--background" },
      ...
      { token: "sidebar-accent", description: "Sidebar accent", lightValue: "--muted", darkValue: "--muted" },
      { token: "sidebar-accent-foreground", description: "Sidebar accent text", lightValue: "--muted-foreground", darkValue: "--muted-foreground" },
    ],
  },
]
