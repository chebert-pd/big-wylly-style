...
function SidebarGroupLabel({
  ...
  return (
    <Comp
      ...
      className={cn(
        "label-sm text-sidebar-foreground/70 ring-sidebar-ring flex h-8 shrink-0 items-center rounded-md px-2 outline-hidden transition-[margin,opacity] duration-200 ease-linear focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0",
...
function SidebarMenuBadge({
  ...
  return (
    <div
      ...
      className={cn(
        "label-sm text-sidebar-foreground pointer-events-none absolute right-1 flex h-5 min-w-5 items-center justify-center rounded-md px-1 tabular-nums select-none",
