...
type DataTableProps<TData, TValue> = {
  ...
  /** Slot rendered above the table card — typically a DataTableToolbar */
  ...
  /** Ref to access the TanStack table instance (e.g. for passing to DataTableToolbar) */
...
export function DataTable<TData, TValue>({
  ...
  const table = useReactTable({
    ...
    onSortingChange: enableSorting ? (setEffectiveSorting as OnChangeFn<SortingState>) : undefined,
    onGlobalFilterChange: enableSearch ? setEffectiveSearch : undefined,
    onExpandedChange: enableExpansion ? setExpanded : undefined,
    onPaginationChange: enablePagination ? (setEffectivePagination as OnChangeFn<PaginationState>) : undefined,
